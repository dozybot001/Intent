...
- The IntHub production profile uses GitHub account sign-in and bounded read-only HttpOnly Web sessions; CLI writes still require a Bearer token, and production uses PostgreSQL; see [IntHub Production Deployment](inthub-production.md)
