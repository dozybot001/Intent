...
def build():
    ...
    html = html.replace('href="/styles.css?rev=soft-cards-2"', 'href="styles.css?rev=soft-cards-2"')
    html = html.replace('src="/app.js?rev=soft-cards-2"', 'src="app.js?rev=soft-cards-2"')
